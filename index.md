...
- El código fuente y notebooks viven en GitHub (este sitio se construye automáticamente desde esa rama).
- El notebook original de modelado está disponible en `notebooks/modelos_sarimax_ffnn.ipynb` dentro del repositorio.
